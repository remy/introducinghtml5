...
__NoTE__ We haven't used a

<header> element in this <article>. <header> is a grouping element that collects together introductory content; as you only have headings already grouped in <hgroup>, there's no need for a further layer of grouping. It wouldn't be an error to use it, but it's superfluous in this example.
